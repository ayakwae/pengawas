...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding-left: 1px; padding-right: 1px;">
  ...
  <div class="collapse navbar-collapse" id="navbar"  style="margin-top: -1px; border-style: solid;border-color: black; border-width: 0px; margin-bottom: -15px; background-color: #DCDCDC;">
    <ul class="navbar-nav mx-auto">
      ...
      <li class="nav-item">
        <a class="nav-link text-expanded" href="<?php echo base_url()?>pengawas" style="font-family: calibri; font-size: 20px; margin-top: -5px; margin-right: 35px; margin-left: 20px;">Pengawas</a>
      </li>
      <li class="nav-item">
        <p class="navbar-nav" style="padding-top: 5px; color: gray; margin-right: 20px;">|</p>
      </li>
      <li class="nav-item">
        <a class="nav-link text-expanded" href="<?php echo base_url()?>koordinator" style="font-family: calibri; font-size: 20px; margin-top: -5px; margin-right: 40px; margin-left: 20px;">Koordinator</a>
      </li>
      <li class="nav-item">
        <p class="navbar-nav" style="padding-top: 5px; color: gray; margin-right: 20px;">|</p>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link text-expanded" href="<?php echo base_url()?>halamanreport" style="font-family: calibri; font-size: 20px; margin-top: -5px; margin-right: 50px; margin-left: 25px;">Laporan</a>
      </li>
      <li class="nav-item">
