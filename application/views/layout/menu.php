<nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding-left: 1px; padding-right: 1px;">
  ...
  <div class="collapse navbar-collapse" id="navbar"  style="margin-top: -1px; border-style: solid;border-color: black; border-width: 0px; margin-bottom: -15px; background-color: #DCDCDC;">
    <ul class="navbar-nav mx-auto">
      ...
      <li class="nav-item">
        <a class="nav-link text-expanded" href="<?php echo base_url()?>" style="font-family: calibri; font-size: 20px; margin-top: -5px; margin-right: 25px; margin-left: 25px;">Beranda<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item text-expanded">
        <a class="nav-link" href="<?php echo base_url()?>loginadmin" style="font-family: calibri; font-size: 20px; margin-top: -5px; margin-left: 25px; margin-right: 25px;">Masuk</a>
      </li>
      <li class="nav-item">
        <p class="navbar-nav" style="padding-top: 5px; color: gray;">|</p>
      </li>
