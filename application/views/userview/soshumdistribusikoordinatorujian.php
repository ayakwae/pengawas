  ...
  <div class="col-md-12">
    <div class="container" style="background: white;font-color:blue;border-width: 1px;border-color: #d6d6c2;padding-top: 8px;padding-bottom: -1px;margin-top: 2.5em">
      <div class="row" style="margin-left: 5px;">
        ...
        <h4 style="color: #2F669F;"><b>Distribusi Koordinator Ujian (SOSHUM)</b></h4>  
      </div>  
    </div>
  </div>
</div>
  ...
  <div class="col-md-12">
    <div class="container" style="background: white;border-width: 1px;border-color: #d6d6c2;padding-bottom: 10px; margin-top: 10px; padding-top: 25px; padding-left: 150px">
      <div class="row" style="margin-top: -10px; margin-left: 60px">
        <a href="<?php base_url() ?>soshumtabelkoordinatorujian">
        ...
        <a href="<?php base_url() ?>soshumtabelkoordinatorutamaujian">
