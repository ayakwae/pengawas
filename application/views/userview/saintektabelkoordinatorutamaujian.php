  ...
  <div class="col-md-12">
    <div class="container" style="background: white;font-color:blue;border-width: 1px;border-color: #d6d6c2;padding-top: 8px;padding-bottom: -1px;margin-top: 2.5em">
      <div class="row" style="margin-left: 5px;">
        ...
        <h4 style="color: #2F669F;"><b>Distribusi Koordinator Utama Ujian (SAINTEK)</b></h4>  
      </div>  
    </div>
  </div>
</div>
  ...
  <div class="col-md-12">
    <div class="container" style="background: white;border-width: 1px;border-color: #d6d6c2;padding-bottom: 10px; margin-top: 10px; padding-top: 25px;">
      <center><form>
        <table border="2" style="width:1050px; margin-bottom: 20px;">
            ...
            echo "<tr>
              ...
              <td><a href='".base_url()."editsaintekkoordinatorutamaujian'><img src='".base_url()."img/icon/edit.png' style='margin-top:0px;margin-left:10px;max-width:30px; max-height: 30px;'></a></td>
      ...
      <table>
        <tr>
          <td>
            <a href="<?php base_url() ?>tambahsaintekdistribusikoordinatorutamaujian">
          ...
          <td>
            <a href="<?php base_url() ?>saintekdistribusikoordinatorujian"><img src="<?php echo base_url()?>img\icon\keluar1.png" style="width: 50px; height: 40px;margin-left: 910px;"></button>
            </a>
          </td>
        </tr>
      </table>
