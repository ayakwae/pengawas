	<div class="row">
			<div class="col-md-12"  >
			<div class="container" style="background: white;font-color:blue;border-width: 1px;border-color: #d6d6c2;padding-top: 1em;padding-bottom: 1em;margin-top: 1em">
				<h4 style="color: #2F669F; padding-left: 10px;"><b>Selamat Datang di</b></h4>
				<h3 style="color: #2F669F; padding-left: 10px;"><b>Sistem Sirkulasi Pengawas Ujian</b></h3>
			</div>
			</div>
		</div>
		<div>&nbsp;</div>
		<div class="row">
			...
			<div class="container-fluid fixed-bottom">
				<div style="background-color: #ffff; color: grey; padding: 15px 25px 10px 20px; margin-top: 69px; margin-left: -15px;margin-right: -15px;height: 40px">
					<h6><center>Copyright &reg; Kelompok ? - Manajemen Sistem Basis Data 2019 - Teknologi Informasi - Universitas Sumatera Utara - 2018/2019</center></h6>
				</div>
