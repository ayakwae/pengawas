        ...
        <div class="col-md-6">
            <div class="container" style="background-color:#1E90FF; border-width: 0px; height:470px;  width: 600px; margin-top: 40px; padding-top: 1px; margin-left: -180px;">
              ...
              <div style="margin-left: 470px; padding-top: 150px;">
                <button type="button" class="btn btn-danger" name="logout" onclick="window.location='<?php echo base_url("auth/logout")?>'">
                  <a href="<?= site_url('auth/logout') ?>">
                  <img src="<?php echo base_url()?>img/icon/keluar.png" style="max-width: 30px; max-height: 60px;">Keluar</a></button>
            </div>
          </div>
        </div>
      </div>
