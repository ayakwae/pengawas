  ...
  <div class="col-md-12">
    <div class="container" style="background: white;font-color:blue;border-width: 1px;border-color: #d6d6c2;padding-top: 8px;padding-bottom: -1px;margin-top: 2.5em">
      <div class="row" style="margin-left: 5px;">
        ...
        <h4 style="color: #2F669F;"><b>Daftar Pengawas (SAINTEK)</b></h4>  
      </div>  
    </div>
  </div>
</div>
...
<div class="container" style="margin-top: 10px;">
  <a href="<?php base_url() ?>tambahsaintekdaftarpengawas">
      ...
      <form><center>
        <table border="2" style="width:1050px; text-align: center; margin-bottom: 20px;">
          ...
          <tr>
            ...
            <td> </td>
            <td> </td>
            <td><a href="<?php base_url() ?>editpengawassaintek"><img src="<?php echo base_url()?>img/icon/edit.png" style="margin-top:0px;margin-left:0px;max-width:30px; max-height: 30px;"></a></td>
          </tr>
          <tr>
            <td>2.</td>
            <td> </td>
        ...
        <td>
            <a href="<?php base_url() ?>saintekdaftarpengawas"><img src="<?php echo base_url()?>img\icon\keluar1.png" style="width: 50px; height: 40px;margin-left: 1020px;"></button>
            </a>
          </td>
    </div>
  </div>
