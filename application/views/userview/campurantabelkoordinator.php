      ...
      <center><form>
        <table border="2" style="width:1050px; margin-bottom: 20px;">
            ...
            echo "<tr>
              ...
              <td><a href='".base_url()."editcampurandistribusikooridnator'><img src='".base_url()."img/icon/edit.png' style='margin-top:0px;margin-left:12px;max-width:30px;max-height:30px;'></a></td>
