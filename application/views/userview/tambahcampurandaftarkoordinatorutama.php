  ...
  <div class="col-md-12">
    <div class="container" style="background: white;font-color:blue;border-width: 1px;border-color: #d6d6c2;padding-top: 1em;padding-bottom: 1em;margin-top: 2.5em">
      <div class="row" style="margin-left: 5px;">
        ...
        <b style="color: #2F669F; font-size: 22px;">Tambah Daftar Koordinator Utama (CAMPURAN)</b>
      </div>  
    </div>
  </div>
</div>
    ...
    <div class="container" style="background: white;border-width: 1px;border-color: #d6d6c2;padding-bottom: 20px; margin-top: 25px; padding-top: 25px;">
      <table>
        ...
        <tr>
          ...
          <td style="padding-left: 230px;"><a href="<?php base_url() ?>campurantabeldaftarkoordinatorutama"><button type="button" class="btn btn-danger"><img src="<?php echo base_url()?>img\icon\keluar.png" style="width: 60px; height: 50px;">Kembali</button></a></td>
        </tr>
        <tr>
