  ...
  <div class="col-md-12">
    <div class="container" style="background: white;font-color:blue;border-width: 1px;border-color: #d6d6c2;padding-top: 8px;padding-bottom: -1px;margin-top: 2.5em">
      <div class="row" style="margin-left: 5px;">
        ...
        <h4 style="color: #2F669F;"><b>Lencana Penanggung Jawab Ruangan (CAMPURAN)</b></h4>  
      </div>  
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-md-12">
    <div class="container" style="background: white;border-width: 1px;border-color: #d6d6c2;padding-bottom: 10px; margin-top: 10px; padding-top: 25px;">
      <form><center>
        <table border="2" style="width:1000px; text-align: center; margin-bottom: 20px;">
          <tr>
            ...
            <th style="font-size: 20px; font-family: calibri;">Nama Penanggung Jawab Ruangan</th>
            ...
            <th style="font-size: 20px; font-family: calibri;">Waktu</th>
          ...
          <tr>
            ...
            <td>test</td>
            <td>test</td>
            <td><a href="<?php base_url() ?>#">CETAK</a></td>
          </tr>
          <tr>
            <td>2.</td>
            <td>test</td>
      ...
      <td style="padding-left: 230px;"><a href="<?php base_url() ?>campuranbadge"><img src="<?php echo base_url()?>img\icon\keluar1.png" style="width: 50px; height: 40px;margin-left: 990px;"></button></a></td>
    </div>
  </div>
</div>