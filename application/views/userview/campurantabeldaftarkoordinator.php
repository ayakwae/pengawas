        ...
        <table border="2" style="width:1000px; text-align: center; margin-bottom: 20px;">
          <tr>
            ...
            echo "<tr>
              ...
              <td><a href='".base_url()."editcampurandaftarkoordinator'><img src='".base_url()."img/icon/edit.png' style='margin-top:0px;margin-left:0px;max-width:30px; max-height: 30px;''><input type='text' name='npu' hidden value='".$v->NPU."' ></a></td>
