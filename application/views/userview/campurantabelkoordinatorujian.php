  ...
  <div class="col-md-12">
    <div class="container" style="background: white;border-width: 1px;border-color: #d6d6c2;padding-bottom: 10px; margin-top: 10px; padding-top: 25px;">
      <center><form>
        <table border="2" style="width:1050px; margin-bottom: 20px;">
            ...
            echo "<tr>
              ...
              <td><a href='".base_url()."editcampurandistribusikoordinatorujian'><img src='".base_url()."img/icon/edit.png' style='margin-top:0px;margin-left:10px;max-width:30px; max-height: 30px;'></a></td>
      ...
      <table>
        <tr>
          <td>
            <a href="<?php base_url() ?>tambahcampurandistribusikoordinatorujian">
