  ...
  <div class="col-md-12">
    <div class="container" style="background: white;font-color:blue;border-width: 1px;border-color: #d6d6c2;padding-top: 8px;padding-bottom: -1px;margin-top: 2.5em">
      <div class="row" style="margin-left: 5px;">
        ...
        <h4 style="color: #2F669F;"><b>Daftar Koordinator Pelatihan (SOSHUM)</b></h4>  
      </div>  
    </div>
  </div>
</div>
...
<div class="container" style="margin-top: 10px;">
  <a href="<?php base_url() ?>tambahsoshumdaftarkoordinator">
        ...
        <table border="2" style="width:1000px; text-align: center; margin-bottom: 20px;">
          <tr>
            ...
            echo "<tr>
              ...
              <td><a href='".base_url()."editsoshumdaftarkoordinator'><img src='".base_url()."img/icon/edit.png' style='margin-top:0px;margin-left:0px;max-width:30px; max-height: 30px;''><input type='text' name='npu' hidden value='".$v->NPU."' ></a></td>
