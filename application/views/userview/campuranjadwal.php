  ...
  <div class="col-md-12">
    <div class="container" style="background: white;border-width: 1px;border-color: #d6d6c2;padding-bottom: 10px; margin-top: 10px; padding-top: 25px;">
      <div class="row" style="margin-top: -10px; margin-left: 60px;" >
        <a href="<?php base_url() ?>pengawasjadwalcampuran">
        ...
        <a href="<?php base_url() ?>pengawassiagajadwalcampuran">
        ...
        <a href="<?php base_url() ?>koordinatorjadwalcampuran">
        ...
        <a href="<?php base_url() ?>koordinatorutamajadwalcampuran">
          <div style="margin-left: 70px; margin-top: 30px; margin-bottom: 15px;">
            <div style="background-color: #D0D0D0; width: 200px; height: 200px;">
        ...
        <a href="<?php base_url() ?>penanggungjawabruanganjadwalcampuran">
          <div style="margin-left: 70px; margin-top: 30px; margin-bottom: 15px;">
        ...
        <td style="padding-left: 230px;"><a href="<?php base_url() ?>lihatjadwal"><img src="<?php echo base_url()?>img\icon\keluar1.png" style="width: 50px; height: 40px;margin-left: 960px;"></button></a></td>
      </div>
    </div>
  </div>
</div>