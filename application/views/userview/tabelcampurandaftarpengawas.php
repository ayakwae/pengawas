      ...
      <form><center>
        <table border="2" style="width:1050px; text-align: center; margin-bottom: 20px;">
          ...
          <tr>
            ...
            <td> </td>
            <td> </td>
            <td><a href="<?php base_url() ?>editpengawascampuran"><img src="<?php echo base_url()?>img/icon/edit.png" style="margin-top:0px;margin-left:0px;max-width:30px; max-height: 30px;"></a></td>
          </tr>
          <tr>
            <td>2.</td>
            <td> </td>
