<?php
Class Presensikoordinatorutama extends CI_Controller{
    ...
    function index(){
        ...
        // mencetak string 
        $pdf->Cell(200 ,7,'DAFTAR HADIR KOORDINATOR UTAMA UJIAN',0,1,'C');
        $pdf->SetFont('Arial','B',12);
        $data = $this->db->get('daftar_presensi_koordinator_utama_campuran')->result();
        foreach ($data as $v) {};
            $pdf->Cell(10,7,'',0,1);
