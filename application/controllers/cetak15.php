...
class Cetak14 extends CI_Controller
{
	public function index()
	{
		...
		$data = array(
   		'record' => $this->db->get('daftar_undangan_koordinator_utama_campuran'));
	}
	public function cetak_id($NPU) {
     $data = array(
      'record'  => $this->db->query("SELECT * FROM daftar_undangan_koordinator_utama_campuran where NPU ='$NPU'"),
    );
